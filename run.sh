...
export OCR_INSTALL=$OCR_HOME/install && export LD_LIBRARY_PATH=$OCR_INSTALL/lib:$APP_HOME/libs/install/x86/lib:$LD_LIBRARY_PATH && export OCR_CONFIG=race-detect.cfg && export CONFIG_NUM_THREADS=1
